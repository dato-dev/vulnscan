...
*Разделы 3 и 4 — про интеграцию с формами и встраиваемый виджет — уехали в
[ROADMAP.md](../ROADMAP.md), майлстоун M12. Здесь их больше нет: черновик
хранит то, что ещё не стало работой, а дублирующее описание разошлось бы с
задачами через месяц.*
