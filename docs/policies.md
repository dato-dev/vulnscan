...
**Имя объекта — это `scan_id` с расширением, а не исходное имя файла.** Имена
файлов часто содержат персональные данные, и мы их не храним — только
расширение. Сопоставить объект с обращением можно по `scan_id` из манифеста.
