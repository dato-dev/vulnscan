...
собирается **растеризацией**, из исходника не остаётся ни одного объекта, и
безопасность не зависит от того, что в нём было.
...
**Цена.** Теряется текстовый слой — документ становится набором картинок. Для
